    ...
    def get_hand(self, tridimensional = False):
        ...
        if result.multi_hand_landmarks:
            for handslms in result.multi_hand_landmarks:
                ...
                q = self.rotation_matrix_from_vectors(np.array((0,1,0)), np.array(dots_relocated[5]))
                ...
                q2 = self.rotation_matrix_from_vectors(np.array((np.linalg.norm(custom_dot),0,0)), custom_dot)
